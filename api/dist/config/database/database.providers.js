...
exports.databaseProviders = [
    {
        ...
        useFactory: async () => {
            ...
            sequelize.addModels([currency_model_1.Currency, web_entity_1.Web, web_gestor_model_1.WebGestor, user_entity_1.User, person_entity_1.Person, gestor_model_1.Gestor, internal_report_model_1.InternalReport]);
            return sequelize;
        },
    },
];
